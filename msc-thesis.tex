...
\usepackage{booktabs}
\usepackage{pifont}      % for \ding checkmark/crossmark symbols
...
\includepdf[offset=25mm -25mm, scale=1]{./Cover_page.pdf}


\title{Automatic Verification of Image-Text Claims with Evidence from the Web}
\authors{Swain Shrestha}
...
\pagestyle{empty}
\cleardoublepage
\addtotoc{Declaration on the Use of AI Tools for Assignment Submission }
\pagestyle{empty}  % No headers or footers for the following pages
\includepdf[offset=25mm -25mm, scale=1, pages=1]{./DeclarationOfAI.pdf}

% Page 2: Offset to the left (reversing the horizontal offset)
\includepdf[offset=-25mm -25mm, scale=1, pages=2]{./DeclarationOfAI.pdf}
