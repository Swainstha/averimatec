...
To guide the QA generation model toward producing high-quality verification questions, the system retrieves the five most semantically similar training claims as in-context learning (ICL) demonstrations. Similarity is computed using sentence embeddings generated by the all-MiniLM-L6-v2 model and cosine similarity:
...
where $\mathcal{D}_{\text{ICL}}$ denotes the set of retrieved demonstrations used in the prompt.
